...
public class Common {
    ...
    private static final int windowWidth = 1450;
    private static final int windowHeight = 800;

    private static final int entityDiameter = 20; //s of drawn entity (customer or store)
    ...
    */
    public static Customer createCustomer(){
        ...
        for(int i = 0; i <ShoppingListLength; i++){
            list.add(chooseProduct());
        }
        return new Customer(X, Y, strategy, list);
    }
